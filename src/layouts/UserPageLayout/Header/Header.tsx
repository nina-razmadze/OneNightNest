        ...
        <nav className="px-4 lg:px-6 py-2.5 bg-secondary-default shadow-lg">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            ...
            <div className="flex items-center lg:order-2">
              <a
                href="#"
                className="text-gray-800 dark:text-white focus:ring-4 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2"
              >
                <Leng />
              </a>
              <a
              ...
              >
                <img src={user} className="w-8 h-8 rounded-full"></img>
              </a>
              <button
