export default function RegisterView() {
  return (
    <section className=" bg-secondary-light min-h-screen w-screen f ">
      <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div className="w-full  rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-secondary-light">
